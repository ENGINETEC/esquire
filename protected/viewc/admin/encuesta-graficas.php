...
if (isset($_GET['success']) && $_GET['success'] == 1) {
    echo 'Materialize.toast(\'Se ha registrado la encuesta exitosamente\', 4000)';
} else if (isset($_GET['error'])) {
    echo 'Materialize.toast(\'Ocurrio un error al registrar la nueva encuesta. Intentenlo nuevamente.\', 4000)';
}
?>
    </script>
</body>
